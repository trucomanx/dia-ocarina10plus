...
################################################################################
mkdir -p $INSTALLPATH/usr/share/dia/shapes/dia-ocarina10plus/
mkdir -p $INSTALLPATH/usr/share/dia/sheets/
cp -v -f $SRCPATH/dia-shapes/shapes/dia-ocarina10plus/*.png   $INSTALLPATH/usr/share/dia/shapes/dia-ocarina10plus/
cp -v -f $SRCPATH/dia-shapes/shapes/dia-ocarina10plus/*.shape $INSTALLPATH/usr/share/dia/shapes/dia-ocarina10plus/
