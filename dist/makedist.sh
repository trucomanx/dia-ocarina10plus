...
################################################################################
mkdir -p $INSTALLPATH/shapes/dia-ocarina10plus/
mkdir -p $INSTALLPATH/sheets/
cp -f $SRCPATH/dia-shapes/shapes/dia-ocarina10plus/*.png   $INSTALLPATH/shapes/dia-ocarina10plus/
cp -f $SRCPATH/dia-shapes/shapes/dia-ocarina10plus/*.shape $INSTALLPATH/shapes/dia-ocarina10plus/
