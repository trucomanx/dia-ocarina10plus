...
SHEET_FILE      := 'dia-shapes/sheets/dia-ocarina10plus.sheet'
...
uninstall:
	...
	rm -r -f ~/.dia/sheets/dia-ocarina10plus.sheet
...
clean:
	...
	$(RM) -r dia-shapes/shapes/dia-ocarina10plus/*.shape
	$(RM) -r dia-shapes/shapes/dia-ocarina10plus/*.png
